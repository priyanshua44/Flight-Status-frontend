...
import "./SearchByAirlineResult.css";
import indigo from "../assets/Indigo.png"

export default function SearchByAirlineResult({ isVisible, onClose, width, onLinkClick }) {
  return (
    <>
      <div
        className={`additional-box2 searchByAirlineResult-box ${isVisible ? "show" : "hide"}`}
        style={{ width }}
      >
